...
ALLOWED_HOSTS = ['www.courtyard.site', '121.4.47.229']
...
CORS_ORIGIN_WHITELIST = (
    'http://127.0.0.1:8080',
    'http://localhost:8080',
    'http://www.courtyard.site:8080',
    'http://www.courtyard.site:80',
...
LOGGING = {
    ...
    'handlers': {  # 定义日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), "logs/courtyardMall.log"),  # 日志文件的位置
...
# 设置静态文件收集目录
STATIC_ROOT = os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), 'courtyardMall_frontend/static')
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'courtyard.utils.exceptions.exception_handler',
    ...
    # 分页类
    'DEFAULT_PAGINATION_CLASS': 'courtyard.utils.pagination.SetPagination',
...
QQ_REDIRECT_URI = 'http://www.courtyard.site:8080/oauth_callback.html'

# 钉钉登陆参数
DT_APP_ID = '1199180434'
DT_APP_KEY = 'ding5uemblzjzfkdq11o'
DT_REDIRECT_URI = 'http://www.courtyard.site:8080/oauth_callback.html'
...
# 指定自定义的django文件存储类
DEFAULT_FILE_STORAGE = 'courtyard.utils.fastdfs.FastDFSStorage.FastDFSStorage'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'INDEX_NAME': 'courtyard',  # 指定elasticsearch建立的索引库的名称
    },
}
...
# 配置读写分离
DATABASE_ROUTERS = ['courtyard.utils.db_router.MasterSlaveDBRouter']
