...
from courtyardMall.utils.models import BaseModel
from courtyardMall.utils.tools import SecretTool, create_jwt_token
...
class User(AbstractUser):
    ...
    def generate_verify_email_url(self):
        ...
        verify_url = 'http://www.courtyard.site:8080/usercenter/verify_email?token=' + token
